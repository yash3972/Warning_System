...
if (!$con) {
    ...
    if (isset($_POST['updateThreshold'])) {
        ...
        $updateQuery = "UPDATE section2 SET threshold8 = '$newThreshold' "; // Update the query accordingly
 ...
 <div class="card-body1">
    ...
    <form method="POST" action="">
        ...
        <div class="part2">
            ...
            <a href="export/export_vwc.php?formattedStartDateTime=<?php echo urlencode($formattedStartDateTime); ?>&formattedEndDateTime=<?php echo urlencode($formattedEndDateTime); ?>"><button type="button" class="btn_primary">Download Data</button></a>
        </div>
         ...
         datasets: [
            {
             ...
             borderWidth: 1.5,
             fill: false,
             data: <?php echo json_encode($vwc1); ?>
         },
            {
             label: 'VWC 2',
             ...
             borderWidth: 1.5,
             fill: false,
             data: <?php echo json_encode($vwc2); ?>
         },
            {
             label: 'VWC 3',
             ...
             borderWidth: 1.5,
             fill: false,
             data: <?php echo json_encode($vwc3); ?>
         },
            {
             label: 'VWC 4',
             ...
             borderWidth: 1.5,
             fill: false,
             data: <?php echo json_encode($vwc4); ?>
         },
            {
             label: 'VWC 5',
             ...
             borderWidth: 1.5,
             fill: false,
             data: <?php echo json_encode($vwc5); ?>
         },
            {
             label: 'THRESHOLD',
             ...
             fill: false,
             data: <?php echo json_encode($threshold8); ?>
         }
