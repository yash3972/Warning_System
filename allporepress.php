...
<?php
 ...
 if(!$con){
    ...
    while($row=mysqli_fetch_array($result)){
        ...
        $porepress1[]=$row['porepress1'];
        $porepress2[]=$row['porepress2'];
        $porepress3[]=$row['porepress3'];
        $porepress4[]=$row['porepress4'];
        $porepress5[]=$row['porepress5'];
...
if (!$con) {
    ...
    if (isset($_POST['updateThreshold'])) {
        ...
        $updateQuery = "UPDATE section2 SET threshold1 = '$newThreshold' "; // Update the query accordingly
 ...
 <div class="card-body1">
    ...
    <form method="POST" action="">
        ...
        <div class="part2">
            ...
            <a href="export/export_porepressure.php?formattedStartDateTime=<?php echo urlencode($formattedStartDateTime); ?>&formattedEndDateTime=<?php echo urlencode($formattedEndDateTime); ?>"><button type="button" class="btn_primary">Download Data</button></a>
        </div>
         ...
         datasets: [
            {
             ...
             borderWidth: 1.5,
             fill: false,
             data: <?php echo json_encode($porepress1); ?>
         },
            {
             label: 'PORE_press2',
             ...
             borderWidth: 1.5,
             fill: false,
             data: <?php echo json_encode($porepress2); ?>
         },
            {
             label: 'PORE_press3',
             ...
             borderWidth: 1.5,
             fill: false,
             data: <?php echo json_encode($porepress3); ?>
         },
            {
             label: 'PORE_press4',
             ...
             borderWidth: 1.5,
             fill: false,
             data: <?php echo json_encode($porepress4); ?>
         },
            {
             label: 'PORE_press5',
             ...
             borderWidth: 1.5,
             fill: false,
             data: <?php echo json_encode($porepress5); ?>
         },
            {
             label: 'threshold',
             ...
             fill: false,
             data: <?php echo json_encode($threshold1); ?>
         }
