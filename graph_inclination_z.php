...
<?php
 ...
 if(!$con){
    ...
    while($row=mysqli_fetch_array($result)){
        ...
        $inclination_z[]=$row['inclination1z'];
    }
 ...
 <div class="card-body1">
    ...
    <form method="POST" action="">
        ...
        <div class="part2">
            ...
            <a href="export/export_inclinZ.php?formattedStartDateTime=<?php echo urlencode($formattedStartDateTime); ?>&formattedEndDateTime=<?php echo urlencode($formattedEndDateTime); ?>"><button type="button" class="btn_primary">Download Data</button></a>
        </div>
 ...
 var myChart = new Chart(ctx, {
     ...
     data: {
         ...
         datasets: [{
             ...
             borderWidth: 2,
             fill: false,
             data: <?php echo json_encode($inclination_z); ?>
         }]
     },
     options: {
        scales: {
