...
<?php
 ...
 if(!$con){
    ...
    while($row=mysqli_fetch_array($result)){
        ...
        $inclination1x[]=$row['inclination1x'];
        $inclination2x[]=$row['inclination2x'];
        $inclination3x[]=$row['inclination3x'];
        $inclination4x[]=$row['inclination4x'];
        $inclination5x[]=$row['inclination5x'];

        $inclination1y[]=$row['inclination1y'];
        $inclination2y[]=$row['inclination2y'];
        $inclination3y[]=$row['inclination3y'];
        $inclination4y[]=$row['inclination4y'];
        $inclination5y[]=$row['inclination5y'];
        

    
        $threshold6[]=$row['threshold6'];
        $threshold7[]=$row['threshold7'];
...
if (!$con) {
    ...
    if (isset($_POST['updateThreshold1'])) {
        ...
        $updateQuery = "UPDATE section2 SET threshold6 = '$newThreshold1' "; // Update the query accordingly
...
}
{
    if (isset($_POST['updateThreshold2'])) {
        ...
        // Update the threshold value in the database
        $updateQuery = "UPDATE section2 SET threshold7 = '$newThreshold2' "; // Update the query accordingly
        $updateResult = mysqli_query($con, $updateQuery);
 ...
 <div class="card-body1">
    ...
    <form method="POST" action="">
        ...
        <div class="part2">
            ...
            <a href="export/export_inclination_x.php?formattedStartDateTime=<?php echo urlencode($formattedStartDateTime); ?>&formattedEndDateTime=<?php echo urlencode($formattedEndDateTime); ?>"><button type="button" class="btn_primary">Download Data</button></a>
        </div>
    ...
    <div class="container">
            <form method="POST" action="">
             ...
             <a href=".php?formattedStartDateTime=<?php echo urlencode($formattedStartDateTime); ?>&formattedEndDateTime=<?php echo urlencode($formattedEndDateTime); ?>"><button type="button" class="btn_primary">Download Data</button></a>
 ...
 <div class="card-body2">
    ...
    <form method="POST" action="">
        ...
        <div class="part2">
            ...
            <a href="export/export_inclination_y.php?formattedStartDateTime=<?php echo urlencode($formattedStartDateTime); ?>&formattedEndDateTime=<?php echo urlencode($formattedEndDateTime); ?>"><button type="button" class="btn_primary">Download Data</button></a>
        </div>
         ...
         datasets: [
            {
             ...
             borderWidth: 1.5,
             fill: false,
             data: <?php echo json_encode($inclination1x); ?>
         },
            {
             label: 'SOIL_tens2',
             ...
             borderWidth: 1.5,
             fill: false,
             data: <?php echo json_encode($inclination2x); ?>
         },
            {
             label: 'SOIL_tens3',
             ...
             borderWidth: 1.5,
             fill: false,
             data: <?php echo json_encode($inclination3x); ?>
         },
            {
             label: 'SOIL_tens4',
             ...
             borderWidth: 1.5,
             fill: false,
             data: <?php echo json_encode($inclination4x); ?>
         },
            {
             label: 'SOIL_tens5',
             ...
             borderWidth: 1.5,
             fill: false,
             data: <?php echo json_encode($inclination5x); ?>
         },
            {
             label: 'threshold',
             ...
             fill: false,
             data: <?php echo json_encode($threshold6); ?>
         }
         ...
         datasets: [
            {
             ...
             borderWidth: 1.5,
             fill: false,
             data: <?php echo json_encode($inclination1y); ?>
         },
            {
             label: 'SOIL_tens2',
             backgroundColor: '#E8A734',
             ...
             borderWidth: 1.5,
             fill: false,
             data: <?php echo json_encode($inclination2y); ?>
         },
            {
             label: 'SOIL_tens3',
             backgroundColor: '#F1CC8B',
             ...
             borderWidth: 1.5,
             fill: false,
             data: <?php echo json_encode($inclination3y); ?>
         },
            {
             label: 'SOIL_tens4',
             backgroundColor: 'rgb(64,0,0)',
             ...
             borderWidth: 1.5,
             fill: false,
             data: <?php echo json_encode($inclination4y); ?>
         },
            {
             label: 'SOIL_tens5',
             backgroundColor: 'rgb(128,0,0)',
             ...
             borderWidth: 1.5,
             fill: false,
             data: <?php echo json_encode($inclination5y); ?>
         },
            {
             label: 'threshold',
             backgroundColor: 'rgb(0,0,0)',
             ...
             fill: false,
             data: <?php echo json_encode($threshold7); ?>
         }
