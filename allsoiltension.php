...
<?php
 ...
 if(!$con){
    ...
    while($row=mysqli_fetch_array($result)){
        ...
        $soiltension1[]=$row['soiltention1'];
        $soiltension2[]=$row['soiltention2'];
        $soiltension3[]=$row['soiltention3'];
        $soiltension4[]=$row['soiltention4'];
        $soiltension5[]=$row['soiltention5'];
...
if (!$con) {
    ...
    if (isset($_POST['updateThreshold'])) {
        ...
        $updateQuery = "UPDATE section2 SET threshold2 = '$newThreshold' "; // Update the query accordingly
 ...
 <div class="card-body1">
    ...
    <form method="POST" action="">
        ...
        <div class="part2">
            ...
            <a href="export/export_soiltention.php?formattedStartDateTime=<?php echo urlencode($formattedStartDateTime); ?>&formattedEndDateTime=<?php echo urlencode($formattedEndDateTime); ?>"><button type="button" class="btn_primary">Download Data</button></a>
        </div>
         ...
         datasets: [
            {
             ...
             borderWidth: 1.5,
             fill: false,
             data: <?php echo json_encode($soiltension1); ?>
         },
            {
             label: 'SOIL_tens2',
             ...
             borderWidth: 1.5,
             fill: false,
             data: <?php echo json_encode($soiltension2); ?>
         },
            {
             label: 'SOIL_tens3',
             ...
             borderWidth: 1.5,
             fill: false,
             data: <?php echo json_encode($soiltension3); ?>
         },
            {
             label: 'SOIL_tens4',
             ...
             borderWidth: 1.5,
             fill: false,
             data: <?php echo json_encode($soiltension4); ?>
         },
            {
             label: 'SOIL_tens5',
             ...
             borderWidth: 1.5,
             fill: false,
             data: <?php echo json_encode($soiltension5); ?>
         },
            {
             label: 'threshold',
             ...
             fill: false,
             data: <?php echo json_encode($threshold2); ?>
         }
