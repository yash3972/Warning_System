 ...
 <div class="card-body1">
    ...
    <form method="POST" action="">
        ...
        <div class="part2">
            ...
            <a href="export/export_rainfall.php?formattedStartDateTime=<?php echo urlencode($formattedStartDateTime); ?>&formattedEndDateTime=<?php echo urlencode($formattedEndDateTime); ?>"><button type="button" class="btn_primary">Download Data</button></a>
        </div>
 ...
 var myChart = new Chart(ctx, {
     ...
     data: {
         ...
         datasets: [{
             ...
             borderWidth: 2,
             fill: false,
             data: <?php echo json_encode($rainfall); ?>
         }]
     },
     options: {
        scales: {
