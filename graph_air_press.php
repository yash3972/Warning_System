...
<?php
 ...
 if(!$con){
    ...
    while($row=mysqli_fetch_array($result)){
        ...
        $airpress[]=$row['airpress'];
    }
    
}
?>
<!DOCTYPE html>
 <html lang="en" style="background: rgb(0,0,0,0);">
 <head>
 ...
 <div class="card-body1">
    ...
    <form method="POST" action="">
        ...
        <div class="part2">
            ...
            <a href="export/export_airpress.php?formattedStartDateTime=<?php echo urlencode($formattedStartDateTime); ?>&formattedEndDateTime=<?php echo urlencode($formattedEndDateTime); ?>"><button type="button" class="btn_primary">Download Data</button></a>
        </div>
 ...
 var myChart = new Chart(ctx, {
     ...
     data: {
         ...
         datasets: [{
             ...
             borderWidth: 2,
             fill: false,
             data: <?php echo json_encode($airpress); ?>
         }]
     },
     options: {
        scales: {
