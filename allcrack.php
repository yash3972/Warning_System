...
<?php
 ...
 if(!$con){
    ...
    $sql="SELECT * FROM allcrack WHERE datetime  BETWEEN '$formattedStartDateTime' AND '$formattedEndDateTime' ORDER BY id ";
...
if (!$con) {
    ...
    if (isset($_POST['updateThreshold'])) {
        ...
        $updateQuery = "UPDATE allcrack SET threshold = '$newThreshold' "; // Update the query accordingly
 ...
 <div class="card-body1">
    ...
    <form method="POST" action="">
        ...
        <div class="part2">
            ...
            <a href="export/export_crack.php?formattedStartDateTime=<?php echo urlencode($formattedStartDateTime); ?>&formattedEndDateTime=<?php echo urlencode($formattedEndDateTime); ?>"><button type="button" class="btn_primary">Download Data</button></a>
        </div>
         ...
         datasets: [
            {
             ...
             borderWidth: 1.5,
             fill: false,
             data: <?php echo json_encode($crack1); ?>
         },
            {
             label: 'CRACK2',
             ...
             borderWidth: 1.5,
             fill: false,
             data: <?php echo json_encode($crack2); ?>
         },
            {
             label: 'CRACK3',
             ...
             borderWidth: 1.5,
             fill: false,
             data: <?php echo json_encode($crack3); ?>
         },
            {
             label: 'CRACK4',
             ...
             borderWidth: 1.5,
             fill: false,
             data: <?php echo json_encode($crack4); ?>
         },
            {
             label: 'CRACK5',
             ...
             borderWidth: 1.5,
             fill: false,
             data: <?php echo json_encode($crack5); ?>
         },
            {
             label: 'threshold',
